...
## [1.0.0] - 2023-06-19
### Added
- More event handler, view and utility functions in `app.js`.

### Changed
_ Renamed `Tailstart` to `Tailwind Starter Kit`.
- Redesign layout and content.
- Redesign 404 page.
- New logo and favicon images.
